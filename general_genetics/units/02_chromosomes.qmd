...
*Figure 2. Human Chromosome 19 is 58,517,616 base pairs long. The image depicts genes as pink lines and intergenic regions as white space.*
...
*Figure 2. Three chromosome types, each with a unique set of genes.*
...
In the image below the number subscripts (e.g. '1') next to the gene name ('A') represent the allele. These homologs carry different alleles for Gene A and C. 
