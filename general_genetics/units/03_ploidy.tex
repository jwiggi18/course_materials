...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Ploidy (course definition)}, coltitle=black, leftrule=.75mm, breakable, left=2mm, toptitle=1mm, titlerule=0mm, opacityback=0, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, colback=white]
...
(two homologs). \textbf{Diploid number} = the \textbf{total} number of
chromosomes in that diploid cell.

\begin{quote}
\textbf{Two symbols you must keep separate}
...
\begin{quote}
\textbf{Why you'll see this later}
...
\begin{quote}
\textbf{One sentence to keep you honest}
